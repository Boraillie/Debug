...
*----------------------------------------------------------------------------
*/
#ifndef _SAM9X6_BIB_H
#define _SAM9X6_BIB_H
...
#define BRD_PIOC_HAS_IO (1) // IO group 2
#define BRD_PIOD_HAS_IO (0) // IO group 3
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
#define BRD_BASE_PIO_OUTPUT  PIOC //PIO->PIO_IO_GROUP[3] <=> PIOD

#define BRD_DS_MASK      (1<<19) // PC19 or PC20         was PD21 on samA5D2

#define BRD_DS_POLARITY  (0)    // (0 => LED On)

#define BRD_PIOA_OUTPUT_MASK  (0) // none
#define BRD_PIOB_OUTPUT_MASK  (0) // none
#define BRD_PIOC_OUTPUT_MASK  (BRD_DS_MASK) // none
...
/*----------------------------------------------------------------------------*/
#define BRD_BASE_PIO_INPUT   PIOC //PIO->PIO_IO_GROUP[3] <=> PIOD
...
#define BRD_S5_MASK       (1<<2)  // PC2     was PD23 sama5d2
#define BRD_S6_MASK       (1<<3)  // PC3     was PD24 sama5d2

#define BRD_PIOA_INPUT_MASK    (0) // none
#define BRD_PIOB_INPUT_MASK    (0) // none
#define BRD_PIOC_INPUT_MASK    (BRD_S5_MASK | BRD_S6_MASK) // none
#define BRD_PIOD_INPUT_MASK    (0)

/* must vbe updated with pio3 stuff MNn*/
...
// to be updated MNn
  #define BRD_UART0_RXD	      PIO_PA1A_URXD0
  #define BRD_UART0_TXD	      PIO_PA0A_UTXD0
