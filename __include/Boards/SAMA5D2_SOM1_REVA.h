...
#define BRD_PIO_MASK_BUSY_CKOUT  (1<<21)
...
// PRG mode inputs ///////////////////////////////////////////////////////////
#define BRD_PIO_BASE_WKUP_STOP   PIOB
#define BRD_PIO_ID_WKUP_STOP     ID_PIOB
#define BRD_PIO_MASK_WKUP_STOP   (1<<3)
...
#define BRD_PIO_MASK_SPCK        (1<<1)
#define BRD_PIO_MASK_MOSI        (1<<2)
#define BRD_PIO_MASK_CSS         (1<<4)
...
#define BRD_PIOC_OUTPUT_MASK  (BRD_PIO_MASK_MISO)
#define BRD_PIOD_OUTPUT_MASK  (0/*BRD_LED1_MASK|BRD_LED2_MASK*/)
#define BRD_PIOE_OUTPUT_MASK  (0) // none

#define BRD_PIOA_INPUT_MASK   (0) // none
#define BRD_PIOB_INPUT_MASK   (BRD_PIO_MASK_WKUP_STOP)
#define BRD_PIOC_INPUT_MASK   (BRD_PIO_MASK_SPCK|BRD_PIO_MASK_MOSI|BRD_PIO_MASK_CSS)
#define BRD_PIOD_INPUT_MASK   (0/*BRD_BP3_MASK|BRD_BP4_MASK*/)
