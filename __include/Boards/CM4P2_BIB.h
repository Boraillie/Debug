...
/* -------- Leds Definition                                                   */
/*----------------------------------------------------------------------------*/
#define BRD_BASE_PIO_DS  PIOE
#define BRD_ID_PIO_DS    ID_PIOE
#define BRD_DS_MASK      (1<<4)	  /* PE4  D4 */

#define BRD_DS_POLARITY 0 // (0 => LED On)

//#define BRD_BASE_PIO_ALL_LED  PIOE
//#define BRD_ID_PIO_ALL_LED    ID_PIOE
//#define BRD_ALL_LED_MASK      (BRD_DS_MASK)
...
#define BRD_PIOE_LED_MASK  (BRD_DS_MASK)
...
#define BRD_S5_MASK       (1<<2)	// PA2   RIGHT CLICK 
#define BRD_S6_MASK       (1<<16)	// PA16  LEFT CLICK

//#define BRD_BASE_PIO_ALL_INPUT  PIOA
//#define BRD_ID_PIO_ALL_INPUT    ID_PIOA
//#define BRD_ALL_INPUT_MASK      (BRD_S5_MASK | BRD_S6_MASK)
