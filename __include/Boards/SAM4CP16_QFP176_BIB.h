...
*----------------------------------------------------------------------------
*/
#ifndef _SAM4C_QFP100_BIB_H
#define _SAM4C_QFP100_BIB_H
...
#define BRD_DS_MASK      (1<<1)  /* PB15 D3 */
...
#define BRD_S5_MASK       (1<<0)
//#define BRD_S6_MASK       (1<<23)

#define BRD_PIOA_INPUT_MASK    (BRD_S5_MASK)
//#define BRD_PIOB_INPUT_MASK    (BRD_S6_MASK) // none
...
// ---- Board Peripherals ----
//----------------------------
#define BRD_UART0 (10) // not wired on J3 / kept for SW compatibility
//------------------------------------------------------------------------------
