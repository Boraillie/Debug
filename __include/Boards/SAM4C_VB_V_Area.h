...
*----------------------------------------------------------------------------
*/
#ifndef _SAM4C_VB_V_AREA_H
#define _SAM4C_VB_V_AREA_H
...
#define BRD_PIOA_INPUT_MASK    (BRD_BP6_MASK)
#define BRD_PIOB_INPUT_MASK    (BRD_BP7_MASK) // none
