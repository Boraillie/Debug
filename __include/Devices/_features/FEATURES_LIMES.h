...
*----------------------------------------------------------------------------
*/
#ifndef _FEATURES_LIMES_H
#define _FEATURES_LIMES_H
...
//-------------------------------------------------
/*
#if defined xxxxxxxxxxxxx
  #include "xxxxxxxxxxxxx.h"
#elif defined yyyyyyyyyyy
  #include "yyyyyyyyyyyyy.h"
#else
...
#define DEVICE_HAS_ADC       (0) //ADC14SDC? //ADC16SDC?
...
#define DEVICE_HAS_LCDC      (1) //SLCDC?
