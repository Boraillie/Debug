...
#ifndef _FEATURES_CANOPUS_H
#define _FEATURES_CANOPUS_H
...
//-------------------------------------------------
#define IRAM_MIN_SIZE (0x40000)   //minimum config for 65103
//------------------------------------------------------------------------------
...
#define DEVICE_HAS_I2SC0     (0)
#define DEVICE_HAS_I2SC1     (0)
...
#define DEVICE_HAS_PDMIC0    (0)
#define DEVICE_HAS_PDMIC1    (0)
