...
*----------------------------------------------------------------------------
* File Name           : features_samxxxx.h
* Object              : ATSAM Definition File.
*
* Creation            : Sept/2011
*----------------------------------------------------------------------------
*/
#ifndef _FEATURES_SAMG53_H
#define _FEATURES_SAMG53_H
...
#define DEVICE_HAS_PDMIC0    (1)
#define DEVICE_HAS_PDMIC1    (1)
...
#define I2SC0_HAS_PDC         (1)
#define I2SC1_HAS_PDC         (1)
//-------------------------------------------

// ---- MATRIX ------------------------------
#define MATRIX_NB_MASTERS         (3)
#define MATRIX_NB_SLAVES          (4)
//-------------------------------------------

// ---- PDMIC -------------------------------
//#define PDMIC_HAS_PDC         (1)
#define PDMIC0_HAS_PDC         (1)
#define PDMIC1_HAS_PDC         (1)
//-------------------------------------------

// ---- PIO ---------------------------------
#define PIO_HAS_PERIPH_A          (1)
#define PIO_HAS_PERIPH_B          (1)
#define PIO_HAS_PERIPH_C          (0) // check G51
...
#define TC_BMR_HAS_FILTER  (0) // check G51
#define TC_HAS_SMMR        (1)
#define TC_HAS_QDEC        (0) // check G51
...
#define SYSC_WPKEY_VAL        0x525443u
//------------------------------------------------------------------------------
