...
*----------------------------------------------------------------------------
*/
#ifndef _FEATURES_SAM4Sxx_H
#define _FEATURES_SAM4Sxx_H
...
//-------------------------------------------------
  ...
  #include "SAM4S/SAM4S_FEATURES_2A.h"
#elif defined __SAM4S2B__
  #include "SAM4S/SAM4S_FEATURES_16B.h" //ERr
#elif defined __SAM4S2C__
  #include "SAM4S/SAM4S_FEATURES_16C.h" //ERr
#elif defined __SAM4S4A__
  #include "SAM4S/SAM4S_FEATURES_2A.h"  //ERr
  ...
  #include "SAM4S/SAM4S_FEATURES_16B.h"
#elif defined __SAM4S16C__
  #include "SAM4S/SAM4S_FEATURES_16C.h"
#elif defined __SAM4SA16B__
  #include "SAM4S/SAM4S_FEATURES_16B.h" //ERr
#elif defined __SAM4SA16C__
  #include "SAM4S/SAM4S_FEATURES_16C.h" //ERr
#elif defined __SAM4SD16B__
  #include "SAM4S/SAM4S_FEATURES_D16B.h"
#elif defined __SAM4SD16C__
  #include "SAM4S/SAM4S_FEATURES_D16C.h"
#elif defined __SAM4SD32B__
  #include "SAM4S/SAM4S_FEATURES_D32B.h"
#elif defined __SAM4SD32C__
  #include "SAM4S/SAM4S_FEATURES_D32C.h"
#else
