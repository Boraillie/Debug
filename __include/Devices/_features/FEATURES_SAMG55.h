...
*----------------------------------------------------------------------------
* File Name           : features_samg55.h
* Object              : ATSAM Definition File.
*
* Creation            : 07/2014
*----------------------------------------------------------------------------
*/
#ifndef _FEATURES_SAMG55_H
#define _FEATURES_SAMG55_H
...
// ---- MATRIX ------------------------------
#define MATRIX_NB_MASTERS         (5)
#define MATRIX_NB_SLAVES          (5)
//-------------------------------------------
