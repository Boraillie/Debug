...
*----------------------------------------------------------------------------
* File Name           : FEATURES_SIRIUS.h
* Object              : ATSAM Definition File.
*
* Creation            : Feb/2013
*----------------------------------------------------------------------------
*/
#ifndef _FEATURES_SIRIUS_H
#define _FEATURES_SIRIUS_H
...
//-------------------------------------------------
#if defined __SIRIUS__
  #include "SIRIUS/SAM4S_FEATURES_D64C.h"
#else
