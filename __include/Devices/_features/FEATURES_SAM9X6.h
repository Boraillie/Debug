...
*----------------------------------------------------------------------------
*/
#ifndef _FEATURES_SAM9X6_H
#define _FEATURES_SAM9X6_H
...
// ??SYSC??
#define DEVICE_HAS_SYSC      1  // SUPply Controller
#define DEVICE_HAS_AIC       1  // Advanced Interrupt Controller
#define DEVICE_HAS_SAIC      0  // Secure Advanced Interrupt Controller
//...
#define DEVICE_HAS_ACC       0  // Analog Comparator Controller
#define DEVICE_HAS_ADC       1  // Analog to Digital Converter
#define DEVICE_HAS_AES       1  // Advanced Encryption Standard
#define DEVICE_HAS_CAN0      1  // Controller Area Network 0
#define DEVICE_HAS_CAN1      1  // Controller Area Network 1
...
#define DEVICE_HAS_XDMAC     1  // D-type Medium Access Control 1
#define DEVICE_HAS_EFC0      0  // Enhanced Flash Controller 0
#define DEVICE_HAS_EFC1      0  // Enhanced Flash Controller 1
#define DEVICE_HAS_EMAC0      1  // G-type Medium Access Control
#define DEVICE_HAS_EMAC1      1  // G-type Medium Access Control
#define DEVICE_HAS_GMAC      0  // G-type Medium Access Control
...
#define DEVICE_HAS_LCDC      1 // Liquid Crystal Display Controller
...
#define DEVICE_HAS_RTT      1  // Real Time Timer
...
#define DEVICE_HAS_SPI3     1  // Serial Protocol Interface 3
#define DEVICE_HAS_SPI4     1  // Serial Protocol Interface 4
#define DEVICE_HAS_SPI5     1  // Serial Protocol Interface 5
#define DEVICE_HAS_SSC      1  // Synchronous Serial Controller 0
...
#define DEVICE_HAS_TWI0     1  // Two Wire Interface 0
#define DEVICE_HAS_TWI1     1  // Two Wire Interface 1
#define DEVICE_HAS_TWI2     1  // Two Wire Interface 2
#define DEVICE_HAS_TWI3     1  // Two Wire Interface 3
#define DEVICE_HAS_TWI5     1  // Two Wire Interface 3
#define DEVICE_HAS_TWI6     1  // Two Wire Interface 3
#define DEVICE_HAS_TWI7     1  // Two Wire Interface 3
#define DEVICE_HAS_TWI8     1  // Two Wire Interface 3
#define DEVICE_HAS_TWI9     1  // Two Wire Interface 3
#define DEVICE_HAS_TWI10    1  // Two Wire Interface 3
#define DEVICE_HAS_TWI11    1  // Two Wire Interface 3
#define DEVICE_HAS_TWI12    1  // Two Wire Interface 3
#define DEVICE_HAS_TWIHS0   0  // High-Speed Two Wire Interface 0
#define DEVICE_HAS_TWIHS1   0  // High-Speed Two Wire Interface 1
#define DEVICE_HAS_UART0    0  // Universal Asynchronous Receiver Transceiver 0  MNn the UART IPs in Flexcom9-12 are treated as USARTS
#define DEVICE_HAS_UART1    0  // Universal Asynchronous Receiver Transceiver 1  MNn the UART IPs in Flexcom9-12 are treated as USARTS
#define DEVICE_HAS_UART2    0  // Universal Asynchronous Receiver Transceiver 2  MNn the UART IPs in Flexcom9-12 are treated as USARTS
#define DEVICE_HAS_UART3    0  // Universal Asynchronous Receiver Transceiver 3  MNn the UART IPs in Flexcom9-12 are treated as USARTS
...
#define DEVICE_HAS_USART4   1  // Universal Synchronous/Asynchronous Receiver Transceiver 3 (mapped to FLEXCOM3 by software wrapper)
#define DEVICE_HAS_USART5   1  // Universal Synchronous/Asynchronous Receiver Transceiver 3 (mapped to FLEXCOM3 by software wrapper)
#define DEVICE_HAS_USART6   1  // Universal Synchronous/Asynchronous Receiver Transceiver 3 (mapped to FLEXCOM3 by software wrapper)
#define DEVICE_HAS_USART7   1  // Universal Synchronous/Asynchronous Receiver Transceiver 3 (mapped to FLEXCOM3 by software wrapper)
#define DEVICE_HAS_USART8   1  // Universal Synchronous/Asynchronous Receiver Transceiver 3 (mapped to FLEXCOM3 by software wrapper)
#define DEVICE_HAS_USART9   1  // Universal Synchronous/Asynchronous Receiver Transceiver 3 (mapped to FLEXCOM3 by software wrapper)
#define DEVICE_HAS_USART10   1  // Universal Synchronous/Asynchronous Receiver Transceiver 3 (mapped to FLEXCOM3 by software wrapper)
#define DEVICE_HAS_USART11   1  // Universal Synchronous/Asynchronous Receiver Transceiver 3 (mapped to FLEXCOM3 by software wrapper)
#define DEVICE_HAS_USART12   1  // Universal Synchronous/Asynchronous Receiver Transceiver 3 (mapped to FLEXCOM3 by software wrapper)
...
#define DEVICE_HAS_DWDT     0  // Dual WatchDog Timer
...
#define DEVICE_HAS_EMAC      DEVICE_HAS_EMAC0
...
#define PMC_HAS_CPU_CKR                 (1)        
#define  PMC_HAS_MOSCRCF                (0)
// ************ PLLA TUNING *****************
...
#define TWI10_IS_FLEXCOM TWI_IS_FLEXCOM    
#define TWI11_IS_FLEXCOM TWI_IS_FLEXCOM    
#define TWI12_IS_FLEXCOM TWI_IS_FLEXCOM    
//--------------------------------------------
...
#define USART4_IS_FLEXCOM USART_IS_FLEXCOM     // MNn The cabling is available for usart functionality
#define USART5_IS_FLEXCOM USART_IS_FLEXCOM     // MNn The cabling is available for usart functionality
#define USART6_IS_FLEXCOM USART_IS_FLEXCOM     // MNn ****The cabling is available for uart functionality not Usart
#define USART7_IS_FLEXCOM USART_IS_FLEXCOM     // MNn ****The cabling is available for uart functionality not Usart
#define USART8_IS_FLEXCOM USART_IS_FLEXCOM     // MNn ****The cabling is available for uart functionality not Usart
#define USART9_IS_FLEXCOM USART_IS_FLEXCOM     // MNn ****The cabling is available for uart functionality not Usart
#define USART10_IS_FLEXCOM USART_IS_FLEXCOM     // MNn ****The cabling is available for uart functionality not Usart
#define USART11_IS_FLEXCOM USART_IS_FLEXCOM     // MNn ****The cabling is available for uart functionality not Usart
#define USART12_IS_FLEXCOM USART_IS_FLEXCOM     // MNn ****The cabling is available for uart functionality not Usart
//-------------------------------------------
//...
//-------------------------------------------
//-------------------------------------------
...
#if defined __SAM9X56__
  #include "SAM9X6/SAM9X56_FEATURES.h"
#elif defined __SAM9X56D0M__
  #include "SAM9X6/SAM9X56D0M_FEATURES.h"
#elif defined __SAM9X56D5M__
  #include "SAM9X6/SAM9X56D5M_FEATURES.h"
#elif defined __SAM9X56D1G__
  #include "SAM9X6/SAM9X56D1G_FEATURES.h"
#else
  #error Library does not support the specified device.
#endif

#endif //_FEATURES_SAM9X6_H
