...
*----------------------------------------------------------------------------
*/
#ifndef _VALID_PATCH_SAMA5D2_H
#define _VALID_PATCH_SAMA5D2_H
...
#warning  !! SRAM_BOOT !!
#else
  #define IRAM_ADDR     0x00200000
#endif
#define IRAM_MIN_SIZE 0x00020000  //128KBmin up to 256KB depending on config
